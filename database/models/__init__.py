...
from database.models import user, content_data_dashboard, link, link_check, message, link_url_domain, page_url_domain


def init_models():
    from database.models import user
    from database.models import content_data_dashboard
